package com.example.pokmonproject

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
 import com.example.pokmonproject.databinding.ActivityMainBinding
import com.google.gson.Gson

import java.io.InputStreamReader
import java.net.URL
import javax.net.ssl.HttpsURLConnection
// weather app can be Sets the current time for four specific regions .
class MainActivity : AppCompatActivity()
{
    ...
    private fun fetchCurrencyData(): Thread
    {
        return Thread {  //url jason >>>
            ...
            if(connection.responseCode == 200)
            {
                ...
                val request = Gson().fromJson(inputStreamReader,recuest::class.java)
                updateUI(request)
    ...
    private fun updateUI(request: recuest)
    {
        runOnUiThread {
            kotlin.run {
